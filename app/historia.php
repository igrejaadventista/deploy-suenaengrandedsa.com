...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>Sueña en Grande - Histórico</title>
	...
	<div id="wrapper" class="overflow-hidden">
		...
		<section id="page-title" class="page-title-parallax page-title-dark page-title-center include-header" style="background-image: url('demos/restaurant/images/geral.jpg'); background-size: cover; padding: 80px 0 80px;" data-bottom-top="background-position:0 0px;" data-top-bottom="background-position:0px -300px;">
			...
			<img src="images/tit_historia.png">
				<span class="fw-normal">Un poco de historia 20 años de éxitos y muchos logros</span>
			</div>
			...
			<div class="content-wrap" >
				<div class="container clearfix">
							...
							<div class="heading-block center">
								<h2>2000</h2>
								<span>Se crea el proyecto Dreaming Alto en Brasil, en la ciudad de Curitiba.</span>
							</div>

							<div class="heading-block center">
								<h2>2001</h2>
								<span>14 de los 16 participantes van a la UNASP-EC para sus estudios en la Universidad.<br><br>Se crea la primera versión del proyecto en Chile, denominada Sueña en GRANDE.</span>
							</div>

							<div class="heading-block center">
								<h2>2003 a 2004</h2>
								<span>Se gradúan los primeros profesionales resultantes del proyecto 2016. El proyecto va más allá y llega a la Conferencia General de la IASD para ser ofrecido a todo el mundo, bajo el nombre Think BIG.</span>
							</div>

							<div class="heading-block center">
								<h2>2000 a 2018</h2>
								<span>Miles de jóvenes se benefician del proyecto. Se estima aproximadamente 30 mil solo en América del Sur.</span>
							</div>

							<div class="heading-block center">
								<h2>2019</h2>
								<span>El proyecto crece aún más en Sudamérica, y alrededor de 35.000 jóvenes comienzan a beneficiarse del programa.</span>
							</div>
